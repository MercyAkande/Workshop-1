...
// ✅ FIX: OrbitControls is global in r149
let controls = new OrbitControls(camera, renderer.domElement);
controls.enableDamping = true;

// Lights
let ambientLight = new THREE.AmbientLight(0x404050, 0.6);
scene.add(ambientLight);

let sunLight = new THREE.DirectionalLight(0xfff1c9, 0.8);
sunLight.position.set(50, 80, 20);
scene.add(sunLight);

let torchLight = new THREE.PointLight(0xffdcaa, 0, 200, 2);
